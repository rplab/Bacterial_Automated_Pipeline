...
for file in range(len(files)):
    ...
    print('Completed validation round ' + str(file))
    tf.compat.v1.reset_default_graph()


#loss_image = np.load('/media/rplab/Stephen Dedalus/automated_pipeline_labels_models/data_and_labels/single_bac_labels/loss_results/training/validation_set_0.npz')['arr_0']